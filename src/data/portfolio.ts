...
export const PORTFOLIO_PROJECTS: PortfolioProject[] = [
  ...
  },
  {
    ...
    description: "Пристройка 48 м² под ключ, демонтаж старого покрытия, замена на металлочерепицу, утепление по периметру, монтаж сайдинга",
    tags: ["Пристройка", "Демонтаж", "Утепление крыши", "Монтаж сайдинга"],
  ...
  },
  {
    ...
    description: "Плохая теплоизоляция и большие теплопотери. Произвели монтаж нового покрытия из металлочерепицы с заменой утеплителя",
    tags: ["Металлочерепица", "Замена утеплителя", "Частный дом"],
